...
export default async function IncidentsPage({ searchParams }: { searchParams: Promise<SearchParams> }) {
  ...
  return (
    <main className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <form className="grid gap-3 rounded-xl border border-slate-200 bg-white p-4 md:grid-cols-3" method="GET">
        ...
        <button type="submit" className="rounded bg-blue-700 p-2 text-white">
          Apply Filters
        </button>
      </form>
